...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    multihead_self_attention = MultiheadSelfAttention(d_model, num_heads, theta, max_seq_len, token_positions)
    multihead_self_attention.q_proj.weight.data = q_proj_weight
    multihead_self_attention.k_proj.weight.data = k_proj_weight
    multihead_self_attention.v_proj.weight.data = v_proj_weight
    multihead_self_attention.o_proj.weight.data = o_proj_weight
...
def run_rope(
    ...
    """
    rope = RotatyPositionalEmbedding(theta, d_k, max_seq_len)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    return train_bbpe(input_path, vocab_size, special_tokens, num_chunks=16)